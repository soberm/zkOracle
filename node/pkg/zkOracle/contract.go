...
// SubmitBlock is a paid mutator transaction binding the contract method 0xab265d6a.
//
// Solidity: function submitBlock(uint256 index, uint256 request, bytes32 blockHash, uint256 postStateRoot, uint256[2] a, uint256[2][2] b, uint256[2] c) returns()
func (_ZKOracleContract *ZKOracleContractTransactor) SubmitBlock(opts *bind.TransactOpts, index *big.Int, request *big.Int, blockHash [32]byte, postStateRoot *big.Int, a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int) (*types.Transaction, error) {
	return _ZKOracleContract.contract.Transact(opts, "submitBlock", index, request, blockHash, postStateRoot, a, b, c)
}

// SubmitBlock is a paid mutator transaction binding the contract method 0xab265d6a.
//
// Solidity: function submitBlock(uint256 index, uint256 request, bytes32 blockHash, uint256 postStateRoot, uint256[2] a, uint256[2][2] b, uint256[2] c) returns()
func (_ZKOracleContract *ZKOracleContractSession) SubmitBlock(index *big.Int, request *big.Int, blockHash [32]byte, postStateRoot *big.Int, a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int) (*types.Transaction, error) {
	return _ZKOracleContract.Contract.SubmitBlock(&_ZKOracleContract.TransactOpts, index, request, blockHash, postStateRoot, a, b, c)
}

// SubmitBlock is a paid mutator transaction binding the contract method 0xab265d6a.
//
// Solidity: function submitBlock(uint256 index, uint256 request, bytes32 blockHash, uint256 postStateRoot, uint256[2] a, uint256[2][2] b, uint256[2] c) returns()
func (_ZKOracleContract *ZKOracleContractTransactorSession) SubmitBlock(index *big.Int, request *big.Int, blockHash [32]byte, postStateRoot *big.Int, a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int) (*types.Transaction, error) {
	return _ZKOracleContract.Contract.SubmitBlock(&_ZKOracleContract.TransactOpts, index, request, blockHash, postStateRoot, a, b, c)
}
...
// FilterBlockSubmitted is a free log retrieval operation binding the contract event 0xaba385cf6627c46da4588514bbc6784d9344e666c69f9823e423dec69ad43afc.
//
// Solidity: event BlockSubmitted(uint256 submitter, uint256 request)
...
// WatchBlockSubmitted is a free log subscription operation binding the contract event 0xaba385cf6627c46da4588514bbc6784d9344e666c69f9823e423dec69ad43afc.
//
// Solidity: event BlockSubmitted(uint256 submitter, uint256 request)
...
// ParseBlockSubmitted is a log parse operation binding the contract event 0xaba385cf6627c46da4588514bbc6784d9344e666c69f9823e423dec69ad43afc.
//
// Solidity: event BlockSubmitted(uint256 submitter, uint256 request)

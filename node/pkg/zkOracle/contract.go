...
//
// Solidity: event BlockRequested(uint256 indexed number, uint256 indexed request)
func (_ZKOracleContract *ZKOracleContractFilterer) FilterBlockRequested(opts *bind.FilterOpts, number []*big.Int, request []*big.Int) (*ZKOracleContractBlockRequestedIterator, error) {
	...
	logs, sub, err := _ZKOracleContract.contract.FilterLogs(opts, "BlockRequested", numberRule, requestRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event BlockRequested(uint256 indexed number, uint256 indexed request)
func (_ZKOracleContract *ZKOracleContractFilterer) WatchBlockRequested(opts *bind.WatchOpts, sink chan<- *ZKOracleContractBlockRequested, number []*big.Int, request []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _ZKOracleContract.contract.WatchLogs(opts, "BlockRequested", numberRule, requestRule)
	if err != nil {
		return nil, err
	}
...
func (_ZKOracleContract *ZKOracleContractFilterer) FilterBlockSubmitted(opts *bind.FilterOpts, request []*big.Int) (*ZKOracleContractBlockSubmittedIterator, error) {
	...
	logs, sub, err := _ZKOracleContract.contract.FilterLogs(opts, "BlockSubmitted", requestRule)
	if err != nil {
		return nil, err
	}
...
func (_ZKOracleContract *ZKOracleContractFilterer) WatchBlockSubmitted(opts *bind.WatchOpts, sink chan<- *ZKOracleContractBlockSubmitted, request []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _ZKOracleContract.contract.WatchLogs(opts, "BlockSubmitted", requestRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event Registered(address indexed sender)
func (_ZKOracleContract *ZKOracleContractFilterer) FilterRegistered(opts *bind.FilterOpts, sender []common.Address) (*ZKOracleContractRegisteredIterator, error) {
	...
	logs, sub, err := _ZKOracleContract.contract.FilterLogs(opts, "Registered", senderRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Registered(address indexed sender)
func (_ZKOracleContract *ZKOracleContractFilterer) WatchRegistered(opts *bind.WatchOpts, sink chan<- *ZKOracleContractRegistered, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZKOracleContract.contract.WatchLogs(opts, "Registered", senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
